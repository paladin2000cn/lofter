...
create(store,{
        ...
        WXAPI.NoticeList({
            ...
            if (append) {
                that.setData({
                    ...
                    articleList: [...that.data.articleList,...res.data.dataList],
                });
            }else {
                that.setData({
                    loadingMoreHidden: true,
                    articleList: res.data.dataList,
                });
            }
            // 停止下拉动作
    ...
    clickNews:function(e){
        ...
        if(e.currentTarget.dataset.url){
            ...
            wx.navigateTo({
                url: '/homeSub/pages/notice/notice?id='+e.currentTarget.dataset.id+'&source='+'GG'
            })
        }
